...
<fieldset id="<?php echo $this->id; ?>-payment-form">
	...
	<div id="pagarme-credit-cart-form">
		<p class="form-row form-row-first">
			<label for="pagarme-card-holder-name"><?php _e( 'Card Holder Name', 'woocommerce-pagarme' ); ?> <small>(<?php _e( 'as recorded on the card', 'woocommerce-pagarme' ); ?>)</small> <span class="required">*</span></label>
		...
		<p class="form-row form-row-last">
			...
			<input id="pagarme-card-number" class="input-text wc-credit-card-form-card-number" type="text" maxlength="20" autocomplete="off" placeholder="•••• •••• •••• ••••" style="font-size: 1.5em; padding: 8px;" />
		</p>
		<div class="clear"></div>
		<p class="form-row form-row-first">
